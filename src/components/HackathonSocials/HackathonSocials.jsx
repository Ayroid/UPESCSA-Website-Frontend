import styles from "./HackathonSocials.module.css";
...
const HackathonSocials = ({ orientation, closeNavbar, gap }) => {
  return (
    <div
...
HackathonSocials.propTypes = {
  orientation: PropTypes.string,
  closeNavbar: PropTypes.func,
  gap: PropTypes.string,
};

export default HackathonSocials;
